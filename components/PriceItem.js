    ...
    return (
        <div className="price-item lg:py-4 sm:py-3 xs:py-2 xs:text-base xs:px-4">
          ...
          <div className="flex-row xs:basis-3/12">
            ...
            <div className="xs:basis-2/12 xs:text-right lg:text-left">
               <span className={`font-mono ${props.change > 0 ? 'green' : 'red'}`}>{props.change}%</span>
           </div>
           <div className="xs:basis-2/12 xs:text-right lg:text-left">
            <span className={`font-mono ${props.change7 > 0 ? 'green' : 'red'}`}>{props.change7}%</span>
          </div>
          <div className="xs:basis-2/12 xs:text-right lg:text-left">
            <span className={`font-mono ${props.change30 > 0 ? 'green' : 'red'}`}>{props.change30}%</span>
          </div>
        </div>
